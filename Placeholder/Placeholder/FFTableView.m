...
- (void)layoutSubviews{
    ...
    CGFloat y = CGRectGetHeight(self.tableHeaderView.bounds);
    CGFloat height = CGRectGetHeight(self.bounds) - CGRectGetHeight(self.tableFooterView.bounds) - CGRectGetHeight(self.tableHeaderView.bounds ) - adjustedContentInset.top;
